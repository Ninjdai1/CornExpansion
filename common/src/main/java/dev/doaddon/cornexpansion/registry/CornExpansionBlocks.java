...
public class CornExpansionBlocks {
    ...
    public static final RegistrySupplier<Block> POPCORN_TIN_BLOCK = BLOCKS.register("popcorn_tin", () -> new EffectFoodBlock(BlockBehaviour.Properties.copy(Blocks.CAKE), 9, CornExpansionObjects.POPCORN_FOOD_PROPERTIES));
