...
public class CornExpansionObjects {
    ...
    public static final FoodProperties BUTTERY_POPCORN_FOOD_PROPERTIES = createFood(1, 0.1F, MobEffectRegistry.SATIATION.get(), 1200, true, true);
    ...
    public static final FoodProperties CHEESY_POPCORN_FOOD_PROPERTIES = createFood(3, 0.3F, MobEffectRegistry.SUSTENANCE.get(), 1200, true, true);
    ...
    public static final FoodProperties CANDIED_POPCORN_FOOD_PROPERTIES = createFood(2, 0.2F, MobEffectRegistry.SWEETS.get(),600, true, true);
