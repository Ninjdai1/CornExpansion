...
public class CornExpansionFoodProperties {
    ...
    public static final FoodProperties BUTTERY_POPCORN_FOOD_PROPERTIES = FoodUtils.createFood(1, 0.1F, MobEffectRegistry.getHolder(MobEffectRegistry.SATIATION), SHORT_DURATION, true, true);
    public static final FoodProperties CHEESY_POPCORN_FOOD_PROPERTIES = FoodUtils.createFood(3, 0.3F, MobEffectRegistry.getHolder(MobEffectRegistry.SUSTENANCE), SHORT_DURATION, true, true);
