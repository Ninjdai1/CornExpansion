...
public class CornExpansionFoodProperties {
    ...
    public static final FoodProperties BUTTERY_POPCORN_FOOD_PROPERTIES = FoodUtils.createFCFood(1, 0.1F, MobEffectRegistry.SATIATION, SHORT_DURATION, true, true);
    public static final FoodProperties CHEESY_POPCORN_FOOD_PROPERTIES = FoodUtils.createFCFood(3, 0.3F, MobEffectRegistry.SUSTENANCE, SHORT_DURATION, true, true);
